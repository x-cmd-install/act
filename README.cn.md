...
[![x-cmd/install — act Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/act.svg?lang=zh)](https://x-cmd.com/install/act)
...
合计: **816,934** 行代码（覆盖前 5 种语言、共 **1954** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| TypeScript | 618,215 | 487,187 | 13,648 | 784 |
| JavaScript | 162,392 | 29,780 | 26,473 | 776 |
| Go | 24,500 | 1,105 | 3,423 | 128 |
| Json | 7,675 | 0 | 0 | 91 |
| Yaml | 3,594 | 48 | 240 | 175 |
...
- **上游仓库**: <https://github.com/nektos/act>
...
- **Star**: 72,094 · **Fork**: 2,041 · **开放 issue**: 1,353 · **贡献者**: 215

## 累计统计

- **发布数**: 97 · **已合并 PR**: 1061 · **开放 PR**: 115 · **已关闭 issue**: 1084 · **开放 issue**: 269 · **提交数**: 1317

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 0 | 0 | 13 | 0 | 9 | 0 |
| last60d | 2026-07-26 | 0 | 0 | 33 | 1 | 11 | 0 |
| 90d | 2026-06-26 | 0 | 0 | 39 | 1 | 13 | 0 |
| last180d | 2026-03-28 | 3 | 2 | 63 | 4 | 25 | 5 |
| 360d | 2025-09-29 | 8 | 10 | 88 | 14 | 46 | 19 |
| last720d | 2024-10-04 | 21 | 110 | 110 | 72 | 137 | 135 |
...
act 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `act` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/act.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:57:14Z._
